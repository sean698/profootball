...
{remainingSourcesChunk1.length > 0 && (
  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
    ...
    {/* RSS Feed Card - Follows same pattern as bottom cards */}
    {(() => {
      const feedData = {
        source: { 
          title: "YardBarker NFL", // CHANGE THIS
          link: "https://fetchrss.com/feed/aJ1CQZlz4cWCaKTeXUpkidWC.rss", // CHANGE THIS
          image: "", // CHANGE THIS
          updatedAt: new Date().toISOString()
        }, 
        articles: [ // CHANGE THESE ARTICLES
          {
            title: "Bills could benefit from a reunion with this player",
            link: "https://www.yardbarker.com/nfl/articles/bills_could_benefit_from_a_reunion_with_this_player/s1_13132_42610317",
            pubDate: new Date().toISOString()
          },
          {
            title: "If Cowboys, Micah Parsons are heading for 'divorce,' they should consider sending him to this AFC contender",
            link: "https://www.yardbarker.com/nfl/articles/if_cowboys_micah_parsons_are_heading_for_divorce_they_should_consider_sending_him_to_this_afc_contender/s1_13132_42609668",
            pubDate: new Date().toISOString()
          },
          {
            title: "Why former safety views starting Joe Flacco as wrong move for Browns",
            link: "https://www.yardbarker.com/nfl/articles/why_former_safety_views_starting_joe_flacco_as_wrong_move_for_browns/s1_13132_42609671",
            pubDate: new Date().toISOString()
          },
          {
            title: "The 'Second-overall NFL Draft picks' quiz",
            link: "https://www.yardbarker.com/nfl/articles/the_second_overall_nfl_draft_picks_quiz/s1__42599632",
            pubDate: new Date().toISOString()
          },
          {
            title: "Rams' Matthew Stafford takes another 'step in the right direction' while recovering from injury",
            link: "https://www.yardbarker.com/nfl/articles/rams_matthew_stafford_takes_another_step_in_the_right_direction_while_recovering_from_injury/s1_13132_42609930",
            pubDate: new Date().toISOString()
          },
        ]
      };
      ...
      const validArticles = (feedData.articles || [])
      ...
      return (
        <div className="bg-white shadow-lg rounded-lg p-4 h-full flex flex-col">
          <div className="flex items-center mb-4">
            {feedData.source.image ? (
              <img
                src={feedData.source.image}
                alt={feedData.source.title}
                className="w-10 h-10 mr-3 rounded-full object-cover"
              />
            ) : (
            ...
            <div>
              <a
                href={`/external/${encodeURIComponent(feedData.source.link)}`}
                className="text-blue-500 hover:text-blue-700"
              >
                <h2 className="text-lg font-bold uppercase text-black cursor-pointer">
                  {decodeHtmlEntities(feedData.source.title)}
                </h2>
              </a>
              <p className="text-gray-500 text-xs">
                Last Updated: {feedData.source.updatedAt ? formatDate(feedData.source.updatedAt) : "--"}
              </p>
            </div>
          </div>
